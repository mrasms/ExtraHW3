...
//______________________________________________________________________________________________________________
        ...
        System.out.println();
        System.out.println(Arrays.toString(fractionalNumbers2) + " - Массив до сортировки");
        for (int i = 0; i < fractionalNumbers2.length; i++) {
            {
                for (int j = 1 + i; j < fractionalNumbers2.length; j++) {
                    double sort = fractionalNumbers2[i];
                    if (sort > fractionalNumbers2[j]) {
                        double x = fractionalNumbers2[j];
                        fractionalNumbers2[i] = x;
                        fractionalNumbers2[j] = sort;
                    }
                }
            }
